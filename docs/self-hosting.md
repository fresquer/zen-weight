...
```env
ZENWEIGHT_PUBLIC_URL=http://your-host.tailnet.ts.net:8081
SUPABASE_PUBLIC_URL=http://your-host.tailnet.ts.net:8000
API_EXTERNAL_URL=http://your-host.tailnet.ts.net:8000
SITE_URL=http://your-host.tailnet.ts.net:8081
ADDITIONAL_REDIRECT_URLS=http://your-host.tailnet.ts.net:8081/reset-password
VITE_SUPABASE_URL=http://your-host.tailnet.ts.net:8000
```
...
Open ZenWeight at `http://your-host.tailnet.ts.net:8081`.

Supabase API and Studio are served through Kong at `http://your-host.tailnet.ts.net:8000`. Do not expose this port directly to the public internet without HTTPS, a reverse proxy, and strong credentials.
